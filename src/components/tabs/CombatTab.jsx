      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-800 border-[3px] border-slate-950 rounded-2xl p-4 shadow-[6px_6px_0px_rgba(0,0,0,1)] relative overflow-hidden">
          ...
          <div className="space-y-3 relative z-10">
             {categorizedActions.action.length === 0 && !isSpellcaster ? (
             ...
             {isSpellcaster && (
               <div className="bg-fuchsia-950/30 border-2 border-fuchsia-900/50 rounded-xl p-3 flex items-center justify-between shadow-[4px_4px_0px_rgba(0,0,0,1)] mt-3">
                  <div className="flex items-center gap-3">
                     <div className="bg-fuchsia-900 p-2 rounded-lg border-2 border-fuchsia-950 shadow-inner">
                       <Flame className="w-5 h-5 text-fuchsia-400" />
                     </div>
                     <div>
                       <span className="text-[11px] md:text-xs font-black text-fuchsia-300 uppercase tracking-widest block drop-shadow-[1px_1px_0px_rgba(0,0,0,1)]">Spellcasting</span>
                       <p className="text-[9px] md:text-[10px] font-bold text-fuchsia-400/80 uppercase tracking-wider">Navigate to the Spells tab to cast magic</p>
                     </div>
                  </div>
               </div>
             )}
