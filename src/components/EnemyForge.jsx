  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-md h-[100dvh] overflow-hidden animate-in fade-in duration-300">
        <div className="bg-slate-900 border-[3px] border-slate-950 rounded-2xl w-full max-w-5xl shadow-[12px_12px_0px_rgba(0,0,0,1)] flex flex-col max-h-[90dvh] relative overflow-hidden">
          
          <div className="p-4 border-b-[3px] border-slate-950 flex justify-between items-center bg-red-500 rounded-t-xl shrink-0 relative z-10">
            <div className="flex items-center gap-4">
               ...
               <div className="flex bg-red-600 rounded-xl p-1 border-2 border-slate-950 shadow-inner">
            ...
            <button onClick={onClose} className="text-slate-950 bg-red-400 hover:bg-red-300 transition-colors p-2 rounded-xl border-2 border-slate-950 shadow-[2px_2px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none"><X className="w-5 h-5 font-black" /></button>
          </div>
              ...
              <form onSubmit={handleSaveCustom} className="space-y-6 animate-in fade-in">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="sm:col-span-2 lg:col-span-4">
                    ...
                    <input type="text" value={enemy.name} onChange={e => setEnemy({...enemy, name: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-4 py-3 text-white text-lg font-black focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. The Brevar Chieftain" />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Size</label>
                    <select value={enemy.size} onChange={e => setEnemy({...enemy, size: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner">
                  ...
                  <div>
                    ...
                    <input type="text" value={enemy.type} onChange={e => setEnemy({...enemy, type: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Undead" />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Alignment</label>
                    <input type="text" value={enemy.alignment} onChange={e => setEnemy({...enemy, alignment: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Chaotic Evil" />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Challenge Rating</label>
                    <input type="number" value={enemy.challenge_rating} onChange={e => setEnemy({...enemy, challenge_rating: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none" />
                  </div>
                </div>

                <div className="grid grid-cols-3 gap-4 bg-slate-900 p-4 rounded-2xl border-[3px] border-slate-950 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                  <div>
                    <label className="flex items-center justify-center gap-1.5 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5"><Heart className="w-4 h-4 text-red-500 drop-shadow-sm" /> HP</label>
                    <input type="number" value={enemy.hp} onChange={e => setEnemy({...enemy, hp: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white text-center font-black text-xl focus:outline-none focus:border-red-500 shadow-inner [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none" />
                  </div>
                  <div>
                    <label className="flex items-center justify-center gap-1.5 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5"><Shield className="w-4 h-4 text-amber-500 drop-shadow-sm" /> AC</label>
                  ...
                  <div>
                    <label className="flex items-center justify-center gap-1.5 text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5"><Wind className="w-4 h-4 text-sky-400 drop-shadow-sm" /> Speed</label>
                    <input type="text" value={enemy.speed} onChange={e => setEnemy({...enemy, speed: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white text-center font-black text-lg focus:outline-none focus:border-red-500 shadow-inner" placeholder="30 ft." />
                  </div>
                </div>

                <div className="bg-slate-900 p-4 rounded-2xl border-[3px] border-slate-950 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                    ...
                    {Object.keys(enemy.stats).map(stat => (
                      <div key={stat} className="bg-slate-950 border-2 border-slate-900 rounded-xl p-3 flex flex-col items-center shadow-inner">
                        ...
                        <input 
                          ...
                          className="w-full bg-transparent text-white font-black text-2xl text-center focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none"
                        />
                      </div>
                    ))}
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div><label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Saving Throws</label><input type="text" value={enemy.saves} onChange={e => setEnemy({...enemy, saves: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Dex +5, Con +4" /></div>
                  <div><label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Skills</label><input type="text" value={enemy.skills} onChange={e => setEnemy({...enemy, skills: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Stealth +6, Perception +4" /></div>
                  <div><label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Damage Resistances</label><input type="text" value={enemy.resistances} onChange={e => setEnemy({...enemy, resistances: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Cold, Fire" /></div>
                  <div><label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Damage Immunities</label><input type="text" value={enemy.immunities} onChange={e => setEnemy({...enemy, immunities: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Poison" /></div>
                  <div><label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Senses</label><input type="text" value={enemy.senses} onChange={e => setEnemy({...enemy, senses: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Darkvision 60 ft." /></div>
                  <div><label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Languages</label><input type="text" value={enemy.languages} onChange={e => setEnemy({...enemy, languages: e.target.value})} className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner" placeholder="e.g. Common, Goblin" /></div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 space-y-4">
                    <div>
                      <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5 flex items-center gap-1.5"><Swords className="w-4 h-4 text-red-500" /> Actions & Attacks</label>
                      <textarea value={enemy.actions} onChange={e => setEnemy({...enemy, actions: e.target.value})} className="w-full h-40 bg-slate-950 border-2 border-slate-900 rounded-xl px-4 py-4 text-slate-300 font-medium text-sm focus:outline-none focus:border-red-500 shadow-inner resize-y custom-scrollbar leading-relaxed" placeholder="Multiattack. The Brevar makes two attacks..." />
                    </div>
                    <div>
                      ...
                      <textarea value={enemy.traits} onChange={e => setEnemy({...enemy, traits: e.target.value})} className="w-full h-40 bg-slate-950 border-2 border-slate-900 rounded-xl px-4 py-4 text-slate-300 font-medium text-sm focus:outline-none focus:border-red-500 shadow-inner resize-y custom-scrollbar leading-relaxed" placeholder="Pack Tactics. The creature has advantage..." />
                    </div>
                  </div>

                  {/* Right Column: Spell Injector */}
                  <div className="bg-slate-900 p-4 md:p-5 rounded-2xl border-[3px] border-slate-950 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                    <label className="text-[10px] font-black text-fuchsia-500 uppercase tracking-widest mb-2 flex items-center gap-1.5 border-b-2 border-slate-950 pb-2">
                      <Wand2 className="w-4 h-4" /> Spell Injector
                    </label>
                    <p className="text-[10px] font-bold text-slate-400 mb-4 leading-relaxed uppercase tracking-wider">Search the SRD to append spell descriptions into the monster block.</p>
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-950 border-2 border-slate-900 rounded-xl pl-9 pr-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-fuchsia-500 shadow-inner" 
                      />
                      {showSpellDropdown && filteredSpells.length > 0 && (
                        <div className="absolute top-full left-0 right-0 mt-2 max-h-48 overflow-y-auto custom-scrollbar bg-slate-900 border-2 border-slate-950 rounded-xl shadow-[4px_4px_0px_rgba(0,0,0,1)] z-50">
                          {filteredSpells.map(s => (
                            <div key={s.index} className="px-3 py-2.5 text-sm font-bold text-slate-300 hover:bg-fuchsia-600 hover:text-white border-b-2 border-slate-950 last:border-0 flex items-center justify-between group transition-colors">
                              <span>{s.name}</span>
                              <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button type="button" onClick={() => handleInjectSpell(s.index, 'actions')} className="bg-slate-950 hover:bg-white hover:text-fuchsia-600 px-2 py-1 rounded text-[10px] font-black uppercase tracking-wider border-2 border-slate-950 shadow-[2px_2px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none transition-all">To Actions</button>
                                <button type="button" onClick={() => handleInjectSpell(s.index, 'traits')} className="bg-slate-950 hover:bg-white hover:text-fuchsia-600 px-2 py-1 rounded text-[10px] font-black uppercase tracking-wider border-2 border-slate-950 shadow-[2px_2px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none transition-all">To Traits</button>
                              </div>
                            </div>
                          ))}
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-900 p-4 md:p-5 rounded-2xl border-[3px] border-slate-950 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                  <ImageSelector 
                    label="Monster Artwork"
                    value={enemy.imageUrl}
                    onChange={(val) => setEnemy({...enemy, imageUrl: val})}
                    iconColor="text-red-500"
                    inputClassName="w-full bg-slate-950 border-2 border-slate-900 rounded-xl px-3 py-2.5 text-white font-bold text-sm focus:outline-none focus:border-red-500 shadow-inner"
                  />
                  <ImageSelector 
                    label="Battle Token"
                ...
                <button type="submit" disabled={isSaving} className="w-full bg-red-600 hover:bg-red-500 text-slate-950 font-black uppercase tracking-widest py-4 rounded-xl transition-all border-[3px] border-slate-950 shadow-[4px_4px_0px_rgba(0,0,0,1)] active:translate-y-[4px] active:shadow-none">
              ...
              <div className="space-y-6 animate-in fade-in">
                ...
                {isSearching ? (
                  ...
                  <div className="space-y-3">
                    {srdEnemies.map(s => (
                      <div key={s.index} className="bg-slate-900 p-4 md:p-5 rounded-2xl border-[3px] border-slate-950 flex flex-col sm:flex-row gap-3 justify-between sm:items-center group shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                        <span className="font-black text-white flex items-center gap-2 text-lg uppercase tracking-widest drop-shadow-[1px_1px_0px_rgba(0,0,0,1)]"><Skull className="w-5 h-5 text-red-500"/> {s.name}</span>
                        <button onClick={() => loadApiEnemyIntoForge(s.url)} disabled={isSaving} className="bg-red-600 hover:bg-red-500 text-slate-950 px-4 py-2.5 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest border-2 border-slate-950 transition-all flex items-center justify-center gap-1.5 shadow-[2px_2px_0px_rgba(0,0,0,1)] active:translate-y-[2px] active:shadow-none w-full sm:w-auto">
                          <Plus className="w-4 h-4"/> Load as Template
                        </button>
                      </div>
                    ))}
                    {searchQuery && srdEnemies.length === 0 && <p className="text-center text-slate-500 font-bold uppercase tracking-widest p-8 border-2 border-dashed border-slate-900 rounded-2xl">No monsters found.</p>}
                  </div>
                )}
              </div>
            )}
