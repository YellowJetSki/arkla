        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-black text-lg flex items-center justify-center gap-2 transition-all duration-300 shadow-lg group overflow-hidden relative mt-4 ${
              isDM 
                ? 'bg-fuchsia-600 hover:bg-fuchsia-500 disabled:opacity-70 text-white shadow-[0_0_25px_rgba(192,38,211,0.3)] hover:shadow-[0_0_35px_rgba(192,38,211,0.5)] border border-fuchsia-400/50'
                : 'bg-indigo-600 hover:bg-indigo-500 disabled:opacity-70 text-white shadow-[0_0_25px_rgba(79,70,229,0.3)] hover:shadow-[0_0_35px_rgba(79,70,229,0.5)] border border-indigo-400/50'
            }`}
          >
